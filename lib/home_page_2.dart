...
class DemoDashboard2 extends StatefulWidget {
  static String tag = '/DemoDashboard2';

  @override
  DemoDashboard2State createState() => DemoDashboard2State();
}
...
class DemoDashboard2State extends State<DemoDashboard2> {
  ...
  void initState() {
    super.initState();
    mListings = db2getCategory().cast<Db2ShopModel>();
    mListings1 = db2getFeatured().cast<Db2ShopModel>();
    mListings2 = db2getProduct().cast<Db2ShopModel>();
  }
